...
INSERT INTO emprestimo_requisicao (id_cliente_fk, id_modalidade_fk, valor_requerido, 
    ...
    id_modalidade_pagamento_fk, data_requisicao, aprovado, descricao_resultado, data_resultado, dia_pagamento, juros_calculado, iof_calculado, valor_parcela)
SELECT 1, 1, 5000.00, 12, 5400.00, 1, 2, 1, 1, 1,  '2024-07-18', true, 'teste descricao', '2024-07-20', 12, 150.00, 50.00, 500.00
WHERE NOT EXISTS (SELECT 1 FROM emprestimo_requisicao WHERE data_requisicao = '2024-07-18' AND id_cliente_fk = 1);

INSERT INTO emprestimo_requisicao (id_cliente_fk, id_modalidade_fk, valor_requerido,
    prazo_mes, valor_total, id_objetivo_fk, id_urgencia_fk, id_iof_fk, id_juros_fk, 
    id_modalidade_pagamento_fk, data_requisicao, aprovado, descricao_resultado, data_resultado, dia_pagamento, juros_calculado, iof_calculado, valor_parcela)
SELECT 2, 2, 2000.00, 15, 7980.00, 2, 1, 1, 1, 1, '2024-07-20', true, 'teste descricao2', '2024-07-20', 15, 100.00, 20.00, 300.00
