                      ...
                      <React.Fragment key={req.idRequisicao}>
                        <div className="br-item" role="listitem" data-toggle="collapse" data-target={`l${req.idRequisicao}`}>
                          <div className="content" onClick={() => handleToggleExpand(req.idRequisicao)}>
                            <div className="flex-fill">Número do Empréstimo: {req.idRequisicao}</div>
                    ...
                    <div className="col-sm-10 col-lg-7 mb-3 mx-auto">
                      <div className="br-input input-inline">
                        <div className="input-label">
                          <label className="text-nowrap" htmlFor="input-id">Digite o Número do Empréstimo</label>
                        </div>
                        <div className="input-content">
                          <input
                            ...
                            placeholder="Digite o Número do Empréstimo que deseja gerar o PDF"
                      ...
                      <div className="mt-3 d-flex justify-content-center">
                        <button
                          className="br-button primary btn-blue"
                          type="button"
